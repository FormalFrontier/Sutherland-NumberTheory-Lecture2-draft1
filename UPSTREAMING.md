...
| 02_02_Remark | `isPrincipalIdealRing_localization_of_isPrincipalIdealRing` | `02_02_Remark.lean:72` | **Candidate** | Proves localization of a PID is a PID for arbitrary submonoids (not just primes). Mathlib has this for localization at a prime via Dedekind detour, but the direct proof for general submonoids may be missing. |
